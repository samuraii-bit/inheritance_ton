...
describe('StoppableCounter', () => {
    ...
    beforeEach(async () => {
        ...
        stoppableCounter = blockchain.openContract(await StoppableCounter.fromInit(0n, 0n));
    ...
    it('should increase counter', async () => {
        ...
        for (let i = 0; i < increaseTimes; i++) {
            ...
            const increaseResult = await stoppableCounter.send(
                increaser.getSender(),
                {
                    value: toNano('0.05'),
                },
            ...
            const counterAfter = await stoppableCounter.getCounter();
